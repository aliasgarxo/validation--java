...
$(document).ready(function() {
	...
	$("button.btn-attach-policies").on("click", { param: "attach-policies" }, btnClickHandler);

	// On-Click handler for 'Fetch' Button - Fetch All AWS Policies
	$("button.btn-fetch-aws-policies").on("click", { param: "fetch-aws-policies" }, btnClickHandler);

	// On-Click handler for 'Detach' Button - Detach Policy in AWS
	$("button.btn-detach-policy").on("click", { param: "detach-policy" }, btnClickHandler);

	// On-Click handler for 'View' Button - View Policy in AWS
	$("button.btn-view-policy").on("click", { param: "view-policy" }, btnClickHandler);
...
function btnClickHandler(e) {
	...
	if (e.data.param === "attach-policies" && nSelectedCount === 0) {
